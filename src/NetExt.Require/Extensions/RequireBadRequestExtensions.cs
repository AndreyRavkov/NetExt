...
public static class RequireBadRequestExtensions
{
    /// <summary>
    ...
    public static void ThrowBadRequestIfNullExt<T>(
        this T? obj,
        ...
        RequireExt.ThrowIfNull(obj, ExceptionTypeExt.BadRequest, errorOrObjectName);
    }
}