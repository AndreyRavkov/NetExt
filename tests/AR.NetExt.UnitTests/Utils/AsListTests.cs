using AR.NetExt.Utils.Collections;
using Xunit;

namespace AR.NetExt.UnitTests.Utils;

public class AsListTestsTests
{
    ...
    [Fact]
    public void AsListTests_Null_Test()
    {
        IEnumerable<decimal>? source = null;

        var result = source.AsListExt();

        Assert.NotNull(result);
        Assert.IsType<List<decimal>>(result, exactMatch: false);
        Assert.Empty(result);
    }
    
    [Fact]
    public void AsListTests_IEnumerable_Test()
    {
    ...
    [Fact]
    public void AsListTests_List_Test()
    {
    ...
    [Fact]
    public void AsListTests_Array_Test()
    {
        int[] source = [-10, 0, 10];
    ...
    [Fact]
    public void AsListTests_Collection_Test()
    {
    ...
    [Fact]
    public void AsListTests_HashSet_Test()
    {
